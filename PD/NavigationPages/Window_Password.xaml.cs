    ...
    public partial class Window_Password : Window
    {
        ...
        {           
            if (e.Key == Key.Enter)
            {
                ...
                if(string.Compare(password, "candy666", true) == 0 || string.Compare(password, "candy555", true) == 0 || string.Compare(password, "QQ123", true) == 0 || string.Compare(password, "qwer", true) == 0)
                {
                    Engineer_Mode();
                }                
            }
